...
A minimalist Gatsby theme based on [Dracula's](https://draculatheme.com) color scheme

```sh
npm i gatsby-theme-dracula
```
...
// gatsby-config.js
module.exports = {
	__experimentalThemes: ['gatsby-theme-dracula']
};
```
...
```sh
mkdir src/gatsby-theme-dracula
```

Next, create a file named `layout.js` in the directory.

```jsx
// src/gatsby-theme-dracula/layout.js
...
// src/gatsby-theme-dracula/layout.js
import React from 'react';
import { Layout, Header, Main, Footer } from 'gatsby-theme-dracula';
